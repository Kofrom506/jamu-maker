...
//    @EnvironmentObject var user: Userx
    ...
    @State var ingridients_temp: [Ingredient] = ingridients
        ...
        GeometryReader{ geo in
            ZStack{
                Image("55")
                    ...
                    .ignoresSafeArea()
                VStack{
                    ForEach(ingridients_temp) { ingridient in
                        Image(ingridient.isUp ? ingridient.imageName : "")
                            ...
                            .onTapGesture {
                                for i in 0..<ingridients_temp.count{
                                    if ingridients_temp[i].id == ingridient.id{
                                        ingridients_temp[i].isUp = false
                                        print(ingridient)
